...
var initialSrc = "https://rtk.healthyhabitsguide.site/" + campaignID + "?format=json";
...
function fixHrefWithClick(
    ...
    document.querySelectorAll('a').forEach(function (el) {
        if (el.href.indexOf("rtk.healthyhabitsguide.site/click") > -1) {
    ...
    if (!urlParams.get('rtkcid')) {
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                xhrr.open("GET", "https://rtk.healthyhabitsguide.site/view?clickid=" + rawData.clickid)
                xhrr.send();
            }
        }
        ...
        xhrTrack.open("GET", "https://rtk.healthyhabitsguide.site/view?clickid=" + rtkClickID)
        xhrTrack.send();
